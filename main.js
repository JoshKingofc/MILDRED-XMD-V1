...
global.channelLink = "https://whatsapp.com/channel/0029VaraMtfFcowAKRdDdp1T";
global.ytch = "🥋Mr Joshuamambo1 tech 🥋";
...
async function handleGroupParticipantUpdate(sock, update) {
    try {
        ...
        if (action === 'add') {
            ...
            const channelId = welcomeData?.channelId || '120363347365643318@newsletter';
        ...
        if (action === 'remove') {
            ...
            const channelId = goodbyeData?.channelId || '120363347365643318@newsletter';
